...
<div class="page-wrapper" style="min-height: 157px;">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="topic.php">Home</a></li>
                      <li class="breadcrumb-item active">Delete Topic</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                    ...
                    <div class="col-md-9 ">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <div id="buttonalign">
                            <form action="#deleteTopic" class="form-valide" method="post" novalidate="novalidate">
                                <button href="#deleteTopic" type="submit" name="submit" class="btn btn-danger">
                                  <div class="row" id="customdelete" ><i class="material-icons"></i> Delete Details</button> </div>
                              </div>
                              <div id="deleteTopic">
                                <?php
                                $query4="DELETE FROM topic WHERE topId=?";
                                ...
                                {  ?>
                                  <div class="alert alert-success">
                                    &nbsp;
                                    <strong>Success! </strong> Topic Detail Deleted.
                                  </div>
                                ...
                                <?php
                                            ...
                                            {
                                                echo "Something went wrong, Topic not Deleted";
                                            }
                                }
                                ?>
                          </form>
