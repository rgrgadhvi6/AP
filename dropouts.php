                    ...
                    <table class="table table-striped table-hover">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                  <a href="viewbusiness.php?id=<?php echo $row['busId'];?>" class="view"  data-toggle="tooltip"   data-placement="top">
                                      <i class="material-icons"></i>
                                  </a>
                                  <a  href="editbusiness.php?id=<?php echo $row['busId'];?>" class="edit" data-toggle="tooltip" title="Edit Business"  data-placement="top">
                                    <i class="material-icons"></i>
                                  </a>
                                  <a  href="deletebusiness.php?id=<?php echo $row['busId'];?>" class="delete" data-toggle="tooltip" title="Delete Business"  data-placement="top">
                                    <i class="material-icons" ></i>
                                  </a>
