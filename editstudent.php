                                  ...
                                  <div class="form-validation">
                                      <form action="#edit" class="form-valide" method="POST">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="stuFirstName" name="stuFirstName" value="<?php echo $row['stuFirstName'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-stuLastName">Student Last Name <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="stuLastName" name="stuLastName" value="<?php echo $row['stuLastName'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-parentName">Student Parent Name <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="parentName" name="parentName" value="<?php echo $row['parentName'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="flagged" name="flagged">
                                                  <option value="NOT SELECTED">Please select</option>
                                                    <option value="Yes"<?php echo($row['flagged']==="Yes")? "selected":"";?>>Yes</option>
                                                    <option value="No"<?php echo($row['flagged']==="No")? "selected":"";?>>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="stuContact" name="stuContact" value="<?php echo $row['stuContact'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="schoolLocation" name="schoolLocation" value="<?php echo $row['schoolLocation'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="schoolContact" name="schoolContact" value="<?php echo $row['schoolContact'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="courseLevel" name="courseLevel" value="<?php echo $row['courseLevel'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="reasonOfDropout" name="reasonOfDropout" value="<?php echo $row['reasonOfDropout'];?>">
                                            </div>
                                        </div>
                                          ...
                                          <?php
                                                  ...
                                                  $query3= "UPDATE `student` SET `stuFirstName`='$stuFirstName',`stuLastName`='$stuLastName', `parentName`='$parentName',`flagged`='$flagged',
                                                  `age`='$age',`contact`='$contact',`stuContact`='$stuContact',`email`='$email',
                                                  `schoolName`='$schoolName',`schoolLocation`='$schoolLocation',`schoolContact`='$schoolContact',`courseLevel`='$courseLevel',`courseName`='$courseName',`reasonOfDropout`='$reasonOfDropout' WHERE stuId = ?";
                                            ...
                                            <div class="alert alert-success">
                                              <strong>Success! </strong> Student Details are Updated.
                                            </div>
                                          ...
                                          <?php
                                                      ...
                                                      {
                                                          echo "Something went wrong, student details not updated";
                                                      }
                                              }
                                          ?>
                                          </div>
