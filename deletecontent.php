...
<div class="page-wrapper" style="min-height: 157px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Content Details</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="content.php">Home</a></li>
                      <li class="breadcrumb-item active">Delete Content</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                    ...
                    <div class="col-md-9 ">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <div id="buttonalign">
                            <form action="#deleteContent" class="form-valide" method="post" novalidate="novalidate">
                                <button href="#deleteContent" type="submit" name="submit" class="btn btn-danger">
                              ...
                              <div id="deleteContent">
                                ...
                                {  ?>
                                  <div class="alert alert-success">
                                    &nbsp;
                                    <strong>Success! </strong> Content Detail Deleted.
                                  </div>
