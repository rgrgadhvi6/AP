                                  ...
                                  <div class="form-validation">
                                      <form action="#add" class="form-valide" method="post">
                                          <div class="form-group row">
                                              <label class="col-lg-4 col-form-label" for="val-courName"> Course Name<span class="text-danger">*</span></label>
                                              <div class="col-lg-6">
                                                  <input type="text" class="form-control" id="courName" name="courName" placeholder="Enter Name of Course">
                                              </div>
                                          </div>
                                          ...
                                          $courName= $_POST['courName'];
                                            ...
                                            $query = "INSERT INTO `course`(`courName`)
                                                      VALUES (?)";
                                            $stmt = mysqli_prepare($conn,$query);
                                            mysqli_stmt_bind_param($stmt,"s",$courName);
                                            mysqli_stmt_execute($stmt);
                                            if(($rows=mysqli_stmt_affected_rows($stmt))==1)
                                            {
                                                  ?><div class="alert alert-success">
                                                    <strong>Success! </strong> Course Name is Added.
                                                  </div>
                                                ...
                                                <?php
                                                            ...
                                                            {
                                                                echo "Something went wrong, Course not Added";
                                                            }
                                          }
                                                ?>
                                                </div>
