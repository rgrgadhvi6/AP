                    ...
                    <table class="table table-striped table-hover">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="viewbusiness.php?id=<?php echo $row['busId'];?>" class="view" title="View Business Details" data-toggle="tooltip"   data-placement="top">
                                        <i class="material-icons"></i>
                                    </a>
                                    <a  href="editbusinessform.php?id=<?php echo $row['busId'];?>" class="edit" data-toggle="tooltip" title="Edit Business"  data-placement="top">
                                      <i class="material-icons"></i>
                                    </a>
                                    <span data-toggle="modal" data-target="#myModal">
                                    <a  href="#myModal?id=<?php echo $row['busId'];?>" class="delete" data-toggle="tooltip" title="Delete Business"  data-placement="top">
                                      <i class="material-icons" ></i>
                                    </a>
                                  </span>
                                  <!-- Delete Modal HTML -->
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                              <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                                ...
                                                <a href="deletebusiness.php?id=<?php echo $row['busId'];?>" class="btn btn-danger" <span>Delete Business</span></a>
