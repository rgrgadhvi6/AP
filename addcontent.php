        ...
        <div class="page-wrapper" style="min-height: 157px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Content</h3> </div>
                                  ...
                                  <div class="form-validation">
                                      <form action="#add" class="form-valide" method="post">
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-lg-6">
                                                  <input type="text" class="form-control" id="conTypeA" name="conTypeA" placeholder="Enter the other info for Content">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-lg-6">
                                                  <input type="text" class="form-control" id="conTypeB" name="conTypeB" placeholder="Enter the other info for Content">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-lg-6">
                                                  <input type="text" class="form-control" id="conTypeC" name="conTypeC" placeholder="Enter the other info for Content">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-lg-6">
                                                  <input type="text" class="form-control" id="conLinkA" name="conLinkA" placeholder="Enter the other info for Content">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-lg-6">
                                                  <input type="text" class="form-control" id="conLinkB" name="conLinkB" placeholder="Enter the other info for Content">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-lg-6">
                                                  <input type="text" class="form-control" id="conDes" name="conDes" placeholder="Enter the Description of Content">
                                              </div>
                                          </div>
                                          ...
                                          $conLinkB = $_POST['conLinkB'];
                                            ...
                                            $query = "INSERT INTO `content`(`conTypeA`,`conTypeB`,`conTypeC`,`conLinkA`,`conLinkB`,`conDes`)
                                                      VALUES (?,?,?,?,?,?)";
                                            $stmt = mysqli_prepare($conn,$query);
                                            mysqli_stmt_bind_param($stmt,"ssssss",$conTypeA,$conTypeB,$conTypeC,$conLinkA,$conLinkB,$conDes);
                                            mysqli_stmt_execute($stmt);
                                            if(($rows=mysqli_stmt_affected_rows($stmt))==1)
                                            {
                                                  ?><div class="alert alert-success">
                                                    <strong>Success! </strong> Content Description(s) Added.
                                                  </div>
                                                ...
                                                <?php
                                                            ...
                                                            {
                                                                echo "Something went wrong, Content Details are not Added";
                                                            }
                                          }
                                                ?>
                                                </div>
