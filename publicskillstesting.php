...
<!-- * -->
  ...
  <div class="page-wrapper" style="min-height: 157px;">
            ...
            <div class="row justify-content-center">
                    ...
                    ?>
                        <p>
                              <div class="col-md-7" data-toggle="collapse" href="#raj" role="button" aria-expanded="false" >
                          ...
                          <div class="col-md-7">
                            <div aria-expanded="false" class="collapse" id="raj2">
                              <div class="card card-body">
                                <ul class="list-icons">
                                  <li><a href="javascript:void(0)"><i class="fa fa-chevron-right"></i>raj</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-7">
                            <div aria-expanded="false" class="collapse" id="raj">
                              <div class="card card-body">
                                <ul class="list-icons">
                                  <li><a href="javascript:void(0)"><i class="fa fa-chevron-right"></i>raj</a></li>
                                </ul>
